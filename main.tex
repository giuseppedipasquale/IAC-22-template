...
\chead{\centerline{\footnotesize \textcolor{gray}{73rd International Astronautical Congress (IAC), Paris, France, 18-22 September 2022.}} \par
\footnotesize \newline \textcolor{gray}{Copyright ©2022 by the International Astronautical Federation (IAF). All rights reserved.} \par
}
\rhead{ }
\lhead{ }

\cfoot{ }
\lfoot{ \textcolor{gray}{IAC-22-B4, 54-C4} }
...
\IACauthor{Author 1$^a$, Author 2$^b$}{$^a$ Affiliation, Country, email address \newline
$^b$ Affiliation2, Country, email address}
...
\begin{figure}
\includegraphics[width=\columnwidth]{figs/examplefigure.png}
...
% Bibliography, style should be changed
